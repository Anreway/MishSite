...
function RiseGroceryPage() {
  ...
  const translatedData = useTranslatedPageData('grocery', groceryPageData);
  ...
  return (
    <div className="App">
      ...
      <div className="milk-products-section">
        <h2 className="milk-products-title">{t('grocery.assortmentTitle')}</h2>
        <div className="milk-products-grid">
          {translatedData.groceryCategories.map((categoryData) => (
            <ProductCard
              key={categoryData.id}
              data={categoryData}
              enableBorderGlow={true}
