...
export const StaggeredMenu = ({
  ...
  // Sync external state
  React.useEffect(() => {
    if (externalIsOpen !== undefined && externalIsOpen !== open) {
  ...
  }, [externalOnToggle, playOpen, playClose, animateIcon, animateColor, animateText, onMenuOpen, onMenuClose]);
  ...
  return (
    ...
    >
      <div ref={preLayersRef} className="sm-prelayers" aria-hidden="true">
        {(() => {
          const raw = colors && colors.length ? colors.slice(0, 4) : ['#F4E87C', '#D4AF37'];
          let arr = [...raw];
          if (arr.length >= 3) {
